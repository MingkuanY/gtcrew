      ...
      <div className={styles.content}>
        ...
        >
          ...
          <input
            ...
            type="text"
            placeholder="Prospective start season (Fall/Spring) and year at GT"
          />
